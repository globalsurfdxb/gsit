                    ...
                    <nav className="hidden lg:flex items-center gap-5 xl:gap-7.5">
                      {headerData.nav.map((item, i) => (
                        <Link
                          key={i}
                          href={item.href}
                          className={`group flex items-center gap-[7px] leading-[1.316] text-[14px] xl:text-19 transition-colors duration-400 font-medium text-paragraph/90 hover:text-black
                           `}
                        >
                          {item.label}
