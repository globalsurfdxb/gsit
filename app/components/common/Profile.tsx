...
export default function Profile({ value, label, description, icon }: StatItem) {
  return (
    <div className="flex flex-col gap-4 odd:ps-0 odd:md:ps-4 odd:xl:ps-6 p-4 pe-3 md:pe-4 md:py-[31.5px] xl:p-6">
      <div className="flex items-baseline ">
        <p className="text-primary font-bold text-[26px] md:text-[36px] 2xl:text-[48px] leading-[1.308] md:leading-[1.3] flex items-baseline gap-1 md:gap-2">
