          ...
          <div className="py-82 2xl:py-[120px]    3xl:py-[160.5px] relative"  ref={sourceRef}>
            ...
            <div className="mt-4 ">
              <HeadingTag
                ...
                className="text-heading  md:whitespace-pre-line max-w-[20ch]"
                text={ctabannermData.heading}
                titlebrake="hidden " 
              />
              <div className="my-4   lg:mb-10.5 max-w-[45ch] xl:max-w-[65ch]"><p className="text-paragraph text-18">{ctabannermData.description}</p></div>
            </div>
            </div> 
            </div>
            <div >
