  ...
  return (
    ...
    >  
      ...
      <div className="container  rounded-2xl">
        <div className="" >
          <div className="py-82 2xl:py-[100px]  3xl:py-[118.5px] relative"  ref={sourceRef}>
            <div className="relative flex flex-col gap-6 2xl:gap-10.5">
            <div>
            ...
            <div><p className="text-18 text-paragraph max-w-[49ch] mt-4">{recomData.description}</p></div>
            </div>
            ...
            <div className="pt-6 2xl:pt-10.5">
