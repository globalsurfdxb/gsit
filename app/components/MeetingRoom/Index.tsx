...
import { bannerData, rightFitData, differenceData, compatibilityData,serverChoicesData,whyChooseUsData, offersData, roomConfigData, approachData, techData, recomData, faqHeaderData, partnersHeaderData, logoData } from "./data";
const Index = () => {
  return (
    <>
