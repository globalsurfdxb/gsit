...
import { bannerData, WifiServicesData,integrationsData,BridgingData, overviewData, zoneCoverageData,recomData, partnersData, faqHeaderData,
  logoData, howweworkData} from "./data";
const Index = () => {
  return (
    <>
      <BannerMain bannerData={bannerData} classpointdes="lg:w-[185px] 3xl:w-[230px]" descstyle="max-w-[60ch]" padding={'pt-[332px]   pb-4 md:py-[82px]  lg:py-[80px] 2xl:py-[128px]  3xl:py-[136px]'} />
