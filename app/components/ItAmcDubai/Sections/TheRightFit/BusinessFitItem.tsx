  ...
  return (
    <div className="flex items-start gap-2 md:gap-4 py-4 lg:py-6 border-b border-[#c3c3c3] last:pb-0 last:border-b-0 ">
      ...
      >
        ...
        <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" fill="#B2DFC3" stroke="#B2DFC3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <path d="M12 8V12" stroke="#FF5900" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M12 16H12.01" stroke="#FF5900" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
