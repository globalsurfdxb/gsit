  ...
  return (
    ...
    >
      {pricingData.map((plan, i) => (
        ...
        {/* cost scope */}
        <div className="grid grid-cols-1 xl:grid-cols-2 3xl:grid-cols-[803px_auto] gap-10 3xl:gap-[103px] mt-8 lg:mt-52">
          <div>
         ...
         <div className="bg-[#F5F9FC] rounded-2xl p-4 md:p-6 mt-4 lg:mt-8">
               <div className="flex flex-col 2xl:flex-row gap-5 items:start 2xl:items-center justify-between">
                <div>
                   <h3 className="text-primary text-32px mb-4  !leading-[1.875] tracking-[-1%]">
