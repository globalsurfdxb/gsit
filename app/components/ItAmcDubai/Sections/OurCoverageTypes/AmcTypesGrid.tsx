  ...
  return (
    <section className="mt-8 md:mt-52">
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-5 lg:gap-y-10.5">
          {sectionEightData.items.map((item, i) => (
            <div key={i} className="flex flex-col gap-4 p-6 lg:px-6 lg:pt-10 lg:pb-0 border-l border-primary">
