  ...
  return (
    <section className="bg-white rounded-2xl py-82">
      <div className="container">
        ...
        <DomainsSection />
<div className="bg-bgF5F9FC p-2 md:p-4 lg:p-6 rounded-2xl mt-8  lg:mt-10.5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-7.5">
 
        <div className="bg-[#FEF2F2] rounded-2xl p-4 lg:p-6">
          <h2 className="text-[#933300] text-32px font-medium  p-2 lg:p-4 mb-3 2xl:mb-8">
          ...
          <div className="flex flex-col lg:px-6 gap-4 lg:gap-6">
            {auditData.business.items.map((item, i) => (
             <div className="flex items-center gap-2 md:gap-4   " key={i}>
                <div
                  className={`bg-[#FCFCFC] w-6 h-6  3xl:w-10.5 3xl:h-10.5 min-w-6 rounded-full flex items-center justify-center `}
                > 
                {item.active 
                  ? (
             ...
             <div className="flex gap-4 lg:gap-[27px] items-center p-4 bg-white rounded-2xl">
              <div >
        ...
        <div className="bg-[#ECF7E7] rounded-2xl p-4 lg:p-6">
          ...
          <div className="flex flex-col lg:px-6 gap-4 lg:gap-6">
            {auditData.challenges.items.map((item, i) => (
             <div className="flex items-center gap-2 md:gap-4   " key={i}>
                <div
                  className={`bg-[#B2DFC3] w-6 h-6  3xl:w-10.5 3xl:h-10.5 min-w-6 rounded-full flex items-center justify-center `}
                > 
                {item.active 
                  ? (
      ...
      {/* Note */}
      <div className="bg-white rounded-2xl p-4 md:p-6 mt-4 lg:mt-8">
       <div className="flex flex-col 2xl:flex-row gap-5 items:start 2xl:items-center justify-between">
        ...
        <p className="text-paragraph text-18  max-w-[80ch] 3xl:max-w-[94ch]">
         ...
         <CustomButton   text={'Talk to an IT Consultant'}   icon="/assets/images/icons/fullarrow.svg"  bgButton={'bg-primary'}  dark={true} />
