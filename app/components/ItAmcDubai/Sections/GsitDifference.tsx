          ...
          <div className="flex flex-col lg:px-3 2xl:px-6 gap-4 lg:gap-6">
            {auditData.business.items.map((item, i) => (
             <div className="flex items-center gap-2 md:gap-2 2xl:gap-4  " key={i}>
                <div
                  className={`bg-[#FCFCFC] w-5 h-5  lg:w-7 lg:h-7 3xl:w-[35px] 3xl:h-[35px] md:m-[3.5px] min-w-5 rounded-full flex items-center justify-center `}
                > 
                {item.active 
                  ? (
            ...
            <path d="M29.75 24.5V3.5" stroke="#933300" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              ...
              <p className="text-18 lg:!text-[14px] 2xl:!text-18 text-[#933300]">Result: 3 to 4 vendors, fragmented SLAs, no single point of accountability. When something breaks, nobody owns it</p>
             </div>
          </div>
        </div>
        ...
        <div className="bg-[#ECF7E7] rounded-2xl p-4 lg:p-6">
          ...
          <div className="flex flex-col lg:px-3 2xl:px-6 gap-4 lg:gap-6">
            ...
            <path d="M29.75 24.5V3.5" stroke="#33580E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              ...
              <p className="text-18 lg:!text-[14px] 2xl:!text-18 text-[#33580E]">Result: One contract. One team. One SLA. One invoice. Total accountability from Day 1</p>
             </div>
          </div>
        </div>
