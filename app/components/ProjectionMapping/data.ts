...
export const throwDistanceData = {
 ...
 tablecolumn: [
  ...
  { key: "throwRatio", label: "Throw Ratio" },
  { key: "distance6m", label: "Distance for 6 m Wide Image" },
  { key: "distance20m", label: "Distance for 20 m Wide Image" },
  { key: "operationalFit", label: "Operational Fit" },
],
    items: [
  {
    priority: "Ultra Short Throw",
    throwRatio: "0.3:1",
    distance6m: "1.8 m",
    distance20m: "N/A (Requires Multi-Array)",
    operationalFit: "Tight interior spaces clearing room foot traffic",
  },
  {
    priority: "Short Throw",
    throwRatio: "0.65:1 to 0.85:1",
    distance6m: "3.9 to 5.1 m",
    distance20m: "13 to 17 m",
    operationalFit: "Exhibition booths, stage sets, and close rigs",
  },
  {
    priority: "Standard Zoom",
    throwRatio: "1.2:1 to 1.8:1",
    distance6m: "7.2 to 10.8 m",
    distance20m: "24 to 36 m",
    operationalFit: "Corporate atriums, galleries, and indoor venues",
  },
  {
    priority: "Long Throw",
    throwRatio: "2.0:1 to 4.0:1",
    distance6m: "12 to 24 m",
    distance20m: "40 to 80 m",
    operationalFit: "Outdoor building facades across roads or plazas",
  },
  {
    priority: "Ultra Long Throw",
    throwRatio: "4.0:1 to 7.5:1",
    distance6m: "24 to 45 m",
    distance20m: "80 to 150 m",
    operationalFit: "Large landmark elevations with distant rig positions",
  },
],
cta: { 
