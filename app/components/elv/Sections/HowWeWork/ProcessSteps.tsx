        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-4 xl:gap-x-7.5 gap-y-10 md:gap-y-13">
          {data.map((step, i) => (
            <div key={i} className="relative ">
              ...
              <div className="relative border border-[#D3D3D3] rounded-lg p-4 lg:p-6  pt-13 min-h-[200px]  xl:min-h-[260px] h-full">
                <span className="absolute -top-px left-16 right-0 " />
                <div className="flex flex-col justify-start md:pt-10 xl:pt-0 xl:justify-end h-full">
