      ...
      {data.map((item, i) => {
        ...
        return (
          <Link
            ...
            className={`group border flex flex-col justify-between rounded-2xl p-5 lg:p-6 gap-4 min-h-[240px] lg:min-h-[240px] 3xl:min-h-[265px] transition-colors duration-500 ${
              active
