      ...
      {data.map((item, i) => {
        ...
        return (
          <Link
            ...
            className={`group border flex flex-col gap-8 justify-between rounded-2xl p-5 lg:p-6 min-h-[240px] lg:min-h-[240px] 3xl:min-h-[243px] transition-colors duration-500 ${
              active
