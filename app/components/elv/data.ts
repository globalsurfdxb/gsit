...
export const featuresData = [
  {
    "icon": "Map",
    "title": "Free site survey before",
    "description": "any commitment"
  },
  {
    "icon": "FileText",
    "title": "SIRA submission",
...
export const offerHeaderData = {
  tag: "What We Offer",
  heading: "Complete ELV & Physical Security Solutions",
  highlightLast: 5, 
...
export const differenceData = {
  ...
  }, 
  {
    ...
    with: "Access attempts are flagged instantly with clear visibility into what happened and where"
  },
  {
    scenario: "Compliance Inspection",
    without: "Gaps surface during inspection, which leads to delays and extra work",
    with: "Health checks ensure compliance, and documentation is kept ready for approvals."
  },
  {
    scenario: "Remote Monitoring",
    without: "Monitoring requires physical presence, making it harder to keep track of everything",
    with: "You can view and manage systems across locations from one place without needing to be on-site"
  },
  {
    scenario: "System Expansion",
    without: "Expanding the system often means rework, and new setups may not fit in properly",
    with: "New components can be added without affecting what's already running, so growth stays simple"
  },
  {
    scenario: "Workforce Tracking",
    without: "Manual tracking creates inconsistencies that affects reporting and payroll accuracy",
    with: "Biometric attendance records stay accurate with direct and real-time system updates"
  },
  {
    scenario: "System Downtime",
    without: "Problems are noticed only after something stops working, which causes business disruption",
    with: "System alerts highlight faults early, allowing quick fixes before operations are affected"
  },
  {
    scenario: "Data Access & Retrieval",
    without: "Finding specific records takes effort, and data may be incomplete or hard to locate",
    with: "Footage and logs remain structured, making retrieval quick and straightforward"
  }
]
};
