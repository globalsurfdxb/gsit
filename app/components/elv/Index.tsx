...
const Index = () => (
  <>
    ...
    <BusinessImpact sectionData={BusinessImpactData} variant={'subtitleBorder'} subtitleClass='max-w-[128ch]' classheight="min-h-[196px] lg:min-h-[251px]" />
    ...
    <ExpertRecommendations data={recomData} descclass="max-w-[48ch]" sectionspace="pt-[393px] pb-4 md:py-82 2xl:py-[100px]  3xl:py-[174.5px]" />
