...
import InstallationWorkflow from '@/app/components/common/Numbox/NumberBox';
import Features from "@/app/components/common/ImageCard";
...
const Index = () => {
  return (
    <>
      <BannerMain bannerData={bannerData} classpointdes="lg:max-w-[210px] 2xl:max-w-[216px]" descstyle="max-w-[59ch]" padding={'pt-[336px]   pb-4 md:py-[82px]  lg:py-[80px] 2xl:py-[128px]  3xl:py-[136.5px]'} />
      ...
      <Features data={featuresData} variant={'subtitleBorder'} />
