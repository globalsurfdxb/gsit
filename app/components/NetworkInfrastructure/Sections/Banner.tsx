      ...
      <div className="container  rounded-2xl">
        <div className="pt-[300px] md:pt-0 pb-4 md:pb-0 " >
          <div className="py-82 2xl:py-[120px]  3xl:py-[142.5px] relative"  ref={sourceRef}>
            ...
            <div>
              <p className="py-5 xl:pt-4 xl:pb-10.5 max-w-[53ch] text-paragraph lg:text-paragraph text-[16px]  lg:text-[18px] 3xl:text-[24px] leading-[1.625] lg:leading-[1.778] 3xl:leading-[1.334] tracking-[-3%] ">{data.desc}</p>
            </div>
