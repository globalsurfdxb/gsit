...
function OverviewCard({ item }: { item: OverviewCardItem }) {
  if (item.highlighted) {
    return (
      <div className="relative overflow-hidden rounded-2xl bg-[linear-gradient(143.49deg,#1A2E6E_3.29%,#4578FF_94.24%)] p-6 lg:p-8 min-h-[280px] lg:min-h-[317px] flex flex-col justify-between">
        <Image
        ...
        <h3 className="relative z-10 text-42  tracking-[-3%]">
  ...
  return (
    <div className="bg-[linear-gradient(180deg,#F2F2F9_0%,#F3F6FF_100%)] rounded-2xl p-6 lg:p-6 min-h-[280px] lg:min-h-[319px] flex flex-col justify-between">
  ...
  return (
    <section className="bg-white rounded-2xl py-82">
      <div className="container">
        ...
        <div className="mt-52 grid grid-cols-1 lg:grid-cols-[auto_auto_778px] gap-4 lg:gap-6">
