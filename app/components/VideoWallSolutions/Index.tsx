...
const Index = () => {
  return (
    <>
      ...
      <DisplayOptions data={displayData} variant={'subtitleBorder'} classtitle='xl:max-w-[42ch] 2xl:max-w-[50ch]' subtitleClass='max-w-[140ch]' columnwidth={{ base: '200px', md: '260px', '3xl': '260px' }}/>
