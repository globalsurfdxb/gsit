...
export default function OnboardingSteps({ data }: OnboardingStepsProps) {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-y-5 md:gap-y-0">
      {data.map((step, i) => {
        ...
        return (
          <div key={i} className="relative flex flex-col">
            ...
            {!isLast && (
              <span className="hidden lg:flex absolute top-[76px] md:top-1/2 -translate-y-1/2 -right-6 lg:-right-7 z-10 items-center justify-center w-11 h-11 md:w-12 md:h-12 rounded-full bg-primary shadow-[0_8px_20px_-4px_rgba(26,46,110,0.4)]">
