  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <path d="M16 6.66602L25.3333 15.9993L16 25.3327" stroke="#114A9F" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>

        </div>
        <div className={`flex flex-col gap-4 transition-all border-b pb-5   duration-700 ${
          featured ? "border-primary w-full " : "border-primary xl:border-transparent w-full xl:w-0"
        }`}>
        </div>
      </div>
    </div>
