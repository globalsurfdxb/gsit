...
const Index = () => {
  return (
    <>
      <BannerMain bannerData={bannerData} classpointdes="lg:w-[170px] 2xl:w-[189px] 3xl:w-[197px]" descstyle="max-w-[62ch]" padding={'pt-[332px]   pb-4 md:py-[82px]  lg:py-[80px] 2xl:py-[128px]  3xl:py-[136.5px]'} />
      ...
      <TechnologyOptions data={technologyOptionsTableData} classdesc="max-w-[66ch]" variant={'subtitleBorder'} subtitleClass='max-w-[140ch]' columnwidth={{ base: '200px', md: '250px', '3xl': '250px' }}/>
