...
import TechnicalCapability from '@/app/components/common/IconCardGrid';
...
const Index = () => {
  return (
    <>
      ...
      <TechnicalCapability data={servicesData} gridcount={3} variant={'default'} subtitleClass="lg:max-w-[38ch] xl:max-w-[62ch]" />
      <HowSupportWorks approachData={postdevelopmentData} variant={'subtitleBorder'} subtitleClass="max-w-[240ch]" gridclass="grid-cols-1 md:grid-cols-2 lg:grid-cols-3 3xl:grid-cols-4   2xl:!gap-x-7.5   " />
