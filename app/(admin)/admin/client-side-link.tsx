  ...
  return (
    <>
      <Link
        ...
        className={cn(
          "flex items-center px-4 py-2.5 rounded-lg transition-colors font-itc-medium justify-between",
          isActive ? "hover:text-white" : "hover:text-primary btn-fill-center",
          isActive
